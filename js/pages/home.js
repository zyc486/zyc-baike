...
const HomePage = {
  ...
  _renderCarousel(shows) {
    ...
    const bgUrl = show.heroImage || show.poster || placeholder('', '12121a', show.logo, 1920, 1080);
    return `
  ...
  _updateCarousel(shows) {
    ...
    setTimeout(() => {
      ...
      if (bg) {
        const newBgUrl = show.heroImage || show.poster || placeholder('', '12121a', show.logo, 1920, 1080);
